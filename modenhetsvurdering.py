...
Et endringsinitiativ kan ha flere konkrete gevinster. Intervjuene kan gjennomføres med fokus på en spesifikk gevinst, eller for initiativet som helhet.
"""
...
questions_data = {
    "Planlegging": [
        ...
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "Er det etablert tilstrekkelig enighet og lojalitet til de definerte gevinstene blant berørt personell gjennom endringsledelsesarbeidet?", "scale": ["Nivå 1: Ingen systematisk arbeid med å bygge enighet eller lojalitet til gevinstene.", "Nivå 2: Begrenset endringsledelsesarbeid - enighet og lojalitet er ikke vurdert.", "Nivå 3: Endringsledelse er planlagt, men effekten på enighet og lojalitet er usikker.", "Nivå 4: Systematisk endringsledelse med dokumentert tilslutning fra hovedinteressenter.", "Nivå 5: Omfattende endringsledelse har skapt bred enighet og aktiv lojalitet til gevinstene i berørt organisasjon."]}
    ],
    "Gjennomføring": [
        ...
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "I hvilken grad oppleves det at endringsledelsesarbeidet har skapt reell enighet og lojalitet til gevinstene blant berørt personell under gjennomføringen?", "scale": ["Nivå 1: Lav enighet - motstand eller likegyldighet til gevinstmålene i berørt organisasjon.", "Nivå 2: Delvis enighet - noen grupper støtter gevinstene, men betydelig motstand finnes.", "Nivå 3: Moderat enighet - flertallet aksepterer gevinstene, men engasjementet varierer.", "Nivå 4: Høy enighet - bred aksept og støtte til gevinstene, med aktiv deltakelse i gjennomføring.", "Nivå 5: Full lojalitet - gevinstene er internalisert som felles mål, berørt personell bidrar proaktivt til å nå dem."]}
    ],
    "Realisering": [
        ...
        {"id": 9, "title": "Gevinstforutsetninger", "question": "Hvordan overvåkes og realiseres gevinstforutsetninger under realiseringen?", "scale": ["Nivå 1: Forutsetninger overvåkes ikke under realisering.", "Nivå 2: Noen forutsetninger følges opp.", "Nivå 3: Systematisk overvåking av forutsetninger.", "Nivå 4: Aktiv realisering av forutsetninger.", "Nivå 5: Forutsetningsrealisering integrert i gevinstuttak."]},
        ...
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "I hvilken grad har endringsledelsesarbeidet resultert i vedvarende enighet og lojalitet til gevinstene når realiseringen pågår?", "scale": ["Nivå 1: Lav enighet - motstand eller tilbaketrekning fra gevinstarbeidet i berørt organisasjon.", "Nivå 2: Delvis enighet - oppslutningen varierer og enkelte grupper trekker seg fra gevinstarbeidet.", "Nivå 3: Moderat enighet - de fleste fortsetter å støtte gevinstene, men engasjementet svinger.", "Nivå 4: Høy enighet - vedvarende støtte og lojalitet til gevinstene gjennom realiseringsfasen.", "Nivå 5: Full lojalitet - sterkt eierskap til gevinstene, berørt personell tar aktivt ansvar for å sikre varig realisering."]}
    ],
    "Realisert": [
        {"id": 1, "title": "Bruk av tidligere læring og gevinstdata", "question": "I hvilken grad er læring fra gevinstrealiseringen dokumentert, delt og integrert i organisasjonens metodeverk for fremtidige initiativer?", "scale": ["Nivå 1: Ingen systematisk dokumentasjon av læring eller erfaringer fra gevinstrealiseringen.", "Nivå 2: Enkelte erfaringer er notert, men ikke strukturert eller tilgjengeliggjort for andre.", "Nivå 3: Læring er dokumentert i sluttrapport, men ikke aktivt delt eller integrert i metodeverk.", "Nivå 4: Erfaringer er systematisk dokumentert, delt i relevante fora, og brukes i planlegging av nye initiativer.", "Nivå 5: Læring er fullt integrert i organisasjonens kunnskapsbase, metodeverk og opplæring, med sporbar effekt på nye initiativer."]},
        {"id": 2, "title": "Strategisk retning og gevinstforståelse", "question": "I hvilken grad har de realiserte gevinstene faktisk bidratt til organisasjonens strategiske mål, og er denne koblingen dokumentert og verifisert?", "scale": ["Nivå 1: Ingen dokumentert kobling mellom realiserte gevinster og strategiske mål.", "Nivå 2: Antatt kobling til strategi, men ikke målt eller verifisert.", "Nivå 3: Delvis dokumentert strategisk effekt for hovedgevinster.", "Nivå 4: Klar dokumentasjon av hvordan gevinstene har bidratt til spesifikke strategiske mål med måltall.", "Nivå 5: Full sporbarhet fra realiserte gevinster til strategisk måloppnåelse, verifisert gjennom KPI-er og rapportert til ledelsen."]},
        {"id": 3, "title": "Gevinstkart og visualisering", "question": "Er gevinstkartet oppdatert med faktisk realiserte verdier, og brukes det som referanse for fremtidige initiativer og kommunikasjon av oppnådde resultater?", "scale": ["Nivå 1: Gevinstkartet er ikke oppdatert eller brukt etter realisering.", "Nivå 2: Kartet eksisterer, men viser fortsatt planlagte verdier uten oppdatering.", "Nivå 3: Gevinstkartet er delvis oppdatert med realiserte verdier for hovedgevinster.", "Nivå 4: Kartet er fullt oppdatert med realiserte verdier og brukes i sluttrapportering.", "Nivå 5: Gevinstkartet er oppdatert, arkivert som referanse, og brukes aktivt i kommunikasjon og som mål for nye initiativer."]},
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Er de realiserte gevinstene målt og rapportert gjennom etablerte KPI-er, og er effekten synlig i organisasjonens styringssystem?", "scale": ["Nivå 1: Ingen måling av realiserte gevinster gjennom KPI-er.", "Nivå 2: Enkelte målinger finnes, men er ikke koblet til organisasjonens KPI-struktur.", "Nivå 3: Hovedgevinster er målt og rapportert, men ikke integrert i løpende styring.", "Nivå 4: Realiserte gevinster er målt gjennom KPI-er og rapporteres i styringsdialog.", "Nivå 5: Full integrasjon der realiserte gevinster er synlige i dashboards, styringssystem og påvirker ressursallokering."]},
        {"id": 5, "title": "Avgrensning av programgevinst", "question": "Er det dokumentert og verifisert hvilke effekter som faktisk skyldes programmet versus andre faktorer, og er denne avgrensningen troverdig og akseptert?", "scale": ["Nivå 1: Ingen dokumentert avgrensning - uklart hva som skyldes programmet.", "Nivå 2: Generell påstand om programmets bidrag uten konkret dokumentasjon.", "Nivå 3: Delvis dokumentert avgrensning for hovedgevinster med rimelig begrunnelse.", "Nivå 4: Systematisk dokumentert effektisolering med metodebeskrivelse og datagrunnlag.", "Nivå 5: Troverdig og verifisert avgrensning akseptert av interessenter, med transparent metodikk som kan gjenbrukes."]},
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Hvordan samsvarer de realiserte gevinstene med opprinnelige estimater, og er avvik analysert og forklart?", "scale": ["Nivå 1: Ingen sammenligning mellom estimater og realiserte verdier.", "Nivå 2: Overordnet sammenligning uten detaljert avviksanalyse.", "Nivå 3: Avvik er identifisert for hovedgevinster med generelle forklaringer.", "Nivå 4: Systematisk avviksanalyse med dokumenterte årsaker og læring for fremtidige estimater.", "Nivå 5: Detaljert analyse av estimatpresisjon brukes aktivt til å forbedre estimeringsmetodikk i organisasjonen."]},
        {"id": 7, "title": "Hypotesetesting og datagrunnlag", "question": "Er de opprinnelige hypotesene om gevinstmekanismer validert eller falsifisert basert på faktiske data, og er denne læringen dokumentert?", "scale": ["Nivå 1: Ingen systematisk validering av opprinnelige hypoteser.", "Nivå 2: Generell vurdering av om hypoteser stemte uten datagrunnlag.", "Nivå 3: Hovedhypoteser er vurdert mot faktiske resultater med noe dokumentasjon.", "Nivå 4: Systematisk validering av hypoteser med datagrunnlag og dokumenterte konklusjoner.", "Nivå 5: Full hypotesevalidering integrert i læringsrapport, med innsikt som forbedrer fremtidige gevinstmodeller."]},
        {"id": 8, "title": "Interessentengasjement", "question": "Hvordan vurderer interessentene selv sin involvering i gevinstrealiseringen, og er deres tilbakemeldinger innhentet og dokumentert?", "scale": ["Nivå 1: Ingen systematisk innhenting av interessenters vurdering.", "Nivå 2: Uformelle tilbakemeldinger fra enkelte interessenter.", "Nivå 3: Strukturert tilbakemelding innhentet fra hovedinteressenter.", "Nivå 4: Omfattende interessentevaluering med dokumenterte funn og forbedringsområder.", "Nivå 5: Interessentvurdering integrert i sluttrapport, med konkrete tiltak for forbedring av fremtidig involvering."]},
        {"id": 9, "title": "Gevinstforutsetninger", "question": "I hvilken grad ble de identifiserte gevinstforutsetningene faktisk oppfylt, og hvordan påvirket dette gevinstrealiseringen?", "scale": ["Nivå 1: Ingen systematisk oppfølging av om forutsetninger ble oppfylt.", "Nivå 2: Generell vurdering uten konkret dokumentasjon av forutsetningsstatus.", "Nivå 3: Hovedforutsetninger er vurdert med dokumentasjon av oppfyllelsesgrad.", "Nivå 4: Systematisk analyse av forutsetningsoppfyllelse og påvirkning på gevinster.", "Nivå 5: Full sporbarhet fra forutsetninger til gevinstresultat, med læring om kritiske forutsetninger for fremtiden."]},
        {"id": 10, "title": "Prinsipielle og vilkårsmessige kriterier", "question": "Ble alle identifiserte kriterier og vilkår for gevinstrealisering oppfylt, og er eventuelle avvik håndtert og dokumentert?", "scale": ["Nivå 1: Ingen oppfølging av om kriterier og vilkår ble oppfylt.", "Nivå 2: Generell vurdering uten systematisk gjennomgang.", "Nivå 3: Hovedkriterier er gjennomgått med dokumentasjon av status.", "Nivå 4: Systematisk gjennomgang av alle kriterier med avvikshåndtering dokumentert.", "Nivå 5: Full dokumentasjon av kriterieoppfyllelse integrert i sluttrapport med læring for fremtidige initiativer."]},
        {"id": 11, "title": "Enighet om nullpunkter/estimater", "question": "Er det oppnådd enighet blant interessenter om de endelige gevinstresultatene, og er eventuelle uenigheter løst eller dokumentert?", "scale": ["Nivå 1: Ingen formell enighet om gevinstresultater - ulike oppfatninger eksisterer.", "Nivå 2: Delvis enighet, men med uløste uenigheter om sentrale gevinster.", "Nivå 3: Enighet om hovedresultater, men noen områder har fortsatt uavklarte spørsmål.", "Nivå 4: Bred enighet om gevinstresultater dokumentert gjennom formell godkjenning.", "Nivå 5: Full konsensus om alle gevinstresultater, med transparent prosess og dokumentert godkjenning fra alle nøkkelinteressenter."]},
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Er frigjorte ressurser fra kostnads- og tidsbesparelser faktisk omdisponert som planlagt, og er denne omdisponeringen dokumentert og verifisert?", "scale": ["Nivå 1: Ingen dokumentasjon av hvordan frigjorte ressurser er disponert.", "Nivå 2: Påstand om omdisponering uten konkret dokumentasjon eller verifisering.", "Nivå 3: Delvis dokumentert omdisponering for hovedbesparelser.", "Nivå 4: Systematisk dokumentasjon av ressursomdisponering med verifisering fra budsjettansvarlige.", "Nivå 5: Full sporbarhet av frigjorte ressurser til ny verdiskapende aktivitet, rapportert i økonomioppfølging."]},
        {"id": 13, "title": "Måling av effektivitet og produktivitet", "question": "Er økt effektivitet og produktivitet målt over tid for å verifisere at gevinstene er varige, ikke bare kortvarige effekter?", "scale": ["Nivå 1: Ingen måling av om effektivitetsgevinster opprettholdes over tid.", "Nivå 2: Enkeltmåling ved prosjektslutt uten oppfølging.", "Nivå 3: Målinger gjennomført i en periode etter realisering med noe dokumentasjon.", "Nivå 4: Systematisk måling over tid som bekrefter varige effekter.", "Nivå 5: Langsiktig målingsprogram etablert som del av linjeorganisasjonens oppfølging, med dokumentert bærekraft."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Er de faktiske ulempene og negative konsekvensene kartlagt og vurdert opp mot de realiserte gevinstene i en helhetlig kost-nytte-vurdering?", "scale": ["Nivå 1: Ingen kartlegging av faktiske ulemper eller negativ påvirkning.", "Nivå 2: Uformell erkjennelse av noen ulemper uten systematisk vurdering.", "Nivå 3: Hovedulemper er identifisert og vurdert mot gevinster.", "Nivå 4: Systematisk kost-nytte-analyse med dokumenterte ulemper og gevinster.", "Nivå 5: Helhetlig evaluering med transparent vurdering av netto verdiskapning, inkludert alle vesentlige ulemper."]},
        {"id": 15, "title": "Balanse mellom gevinster og ulemper", "question": "Er den endelige balansen mellom oppnådde gevinster og påførte ulemper vurdert som akseptabel av interessentene, og er denne vurderingen dokumentert?", "scale": ["Nivå 1: Ingen formell vurdering av gevinst-ulempe-balansen.", "Nivå 2: Uformell vurdering uten interessentinvolvering.", "Nivå 3: Vurdering gjennomført med noe interessentinvolvering.", "Nivå 4: Formell vurdering med dokumentert aksept fra hovedinteressenter.", "Nivå 5: Omfattende evaluering med bred interessentinvolvering og dokumentert konsensus om at balansen er akseptabel."]},
        {"id": 16, "title": "Dokumentasjon og gevinstrealiseringsplan", "question": "Er gevinstrealiseringsplanen oppdatert med faktiske resultater og arkivert som referansedokument for organisasjonen?", "scale": ["Nivå 1: Gevinstrealiseringsplanen er ikke oppdatert eller arkivert.", "Nivå 2: Planen eksisterer, men er ikke oppdatert med faktiske resultater.", "Nivå 3: Planen er delvis oppdatert med hovedresultater.", "Nivå 4: Planen er fullt oppdatert med alle resultater og avvik dokumentert.", "Nivå 5: Oppdatert plan er arkivert som beste praksis-referanse og brukes aktivt i opplæring og nye initiativer."]},
        {"id": 17, "title": "Gevinstrealiseringsplan som operativ handlingsplan", "question": "Fungerte gevinstrealiseringsplanen effektivt som operativt styringsverktøy gjennom hele realiseringen, og er erfaringene med dette dokumentert?", "scale": ["Nivå 1: Planen ble ikke brukt operativt - kun et plandokument.", "Nivå 2: Planen ble brukt sporadisk uten systematisk oppfølging.", "Nivå 3: Planen ble brukt som styringsverktøy for deler av realiseringen.", "Nivå 4: Planen fungerte som aktivt styringsverktøy med regelmessig oppdatering og oppfølging.", "Nivå 5: Planen var sentralt styringsverktøy gjennom hele realiseringen, med dokumenterte erfaringer for metodeforbedring."]},
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Hadde organisasjonen tilstrekkelig kapasitet og kompetanse til å ta imot og forankre endringene varig, og er dette evaluert?", "scale": ["Nivå 1: Ingen evaluering av organisasjonens mottaksevne eller endringskapasitet.", "Nivå 2: Uformell vurdering uten systematisk evaluering.", "Nivå 3: Evaluering gjennomført for hovedområder med noe dokumentasjon.", "Nivå 4: Systematisk evaluering av mottaksevne med dokumenterte funn og forbedringsområder.", "Nivå 5: Omfattende evaluering med konkrete anbefalinger implementert for å styrke fremtidig endringskapasitet."]},
        {"id": 19, "title": "Kommunikasjon og forankring", "question": "Er de realiserte gevinstene kommunisert til organisasjonen, og oppleves endringene som varig forankret i kultur og arbeidsprosesser?", "scale": ["Nivå 1: Ingen systematisk kommunikasjon av oppnådde resultater.", "Nivå 2: Begrenset kommunikasjon til utvalgte grupper.", "Nivå 3: Resultater kommunisert bredt, men usikkert om varig forankring.", "Nivå 4: Systematisk kommunikasjon med dokumentert forankring i berørt organisasjon.", "Nivå 5: Gevinstene er kommunisert som suksesshistorie, og endringene er observerbart integrert i daglig praksis og kultur."]},
        {"id": 20, "title": "Eierskap og ansvar", "question": "Er det etablert varig eierskap i linjen for å opprettholde de realiserte gevinstene, og er ansvar og roller for vedlikehold definert?", "scale": ["Nivå 1: Ingen definert eierskap for vedlikehold av gevinster etter prosjektslutt.", "Nivå 2: Uformelt eierskap uten klare roller eller ansvar.", "Nivå 3: Eierskap definert for hovedgevinster, men ikke fullt operasjonalisert.", "Nivå 4: Klart definert eierskap med roller og ansvar dokumentert og overført til linjen.", "Nivå 5: Varig eierskap etablert med integrering i stillingsbeskrivelser, målstyring og oppfølgingsrutiner."]},
        {"id": 21, "title": "Periodisering og forankring", "question": "Ble gevinstene realisert i henhold til planlagt periodisering, og er avvik fra tidsplan analysert og forklart?", "scale": ["Nivå 1: Ingen sammenligning mellom planlagt og faktisk periodisering.", "Nivå 2: Overordnet vurdering uten detaljert analyse av tidsavvik.", "Nivå 3: Avvik fra periodisering identifisert for hovedgevinster med generelle forklaringer.", "Nivå 4: Systematisk analyse av periodiseringsavvik med dokumenterte årsaker.", "Nivå 5: Detaljert periodiseringsanalyse brukes til å forbedre fremtidig gevinstplanlegging og gi mer realistiske tidsestimater."]},
        {"id": 22, "title": "Realisme og engasjement", "question": "Viste de endelige resultatene at de opprinnelige estimatene var realistiske, og har dette påvirket organisasjonens troverdighet og engasjement for fremtidige gevinstarbeid?", "scale": ["Nivå 1: Stor diskrepans mellom estimater og resultater som har svekket troverdighet.", "Nivå 2: Moderate avvik som har skapt noe skepsis til fremtidige estimater.", "Nivå 3: Akseptable avvik som ikke vesentlig har påvirket troverdighet.", "Nivå 4: God overensstemmelse mellom estimater og resultater som styrker tillit.", "Nivå 5: Høy presisjon i estimater har betydelig styrket organisasjonens engasjement og tillit til gevinstarbeid."]},
        {"id": 23, "title": "Bygge momentum og tidlig gevinstuttak", "question": "Bidro tidlig gevinstuttak til å bygge momentum og opprettholde engasjement gjennom hele realiseringen, og er denne effekten evaluert?", "scale": ["Nivå 1: Ingen tidlig gevinstuttak eller evaluering av momentum-effekt.", "Nivå 2: Noe tidlig gevinstuttak uten systematisk evaluering av effekten.", "Nivå 3: Tidlige gevinster ble realisert og bidro til engasjement, med noe dokumentasjon.", "Nivå 4: Systematisk tidlig gevinstuttak med dokumentert positiv effekt på momentum og engasjement.", "Nivå 5: Tidlig gevinstuttak var strategisk planlagt og evaluert, med læring som forbedrer fremtidige initiativer."]},
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "I hvilken grad har arbeidet med endringsledelse resultert i reell enighet og lojalitet til de definerte gevinstene blant berørt personell?", "scale": ["Nivå 1: Lav enighet - betydelig motstand eller likegyldighet til gevinstmålene blant berørt personell.", "Nivå 2: Delvis enighet - noen grupper støtter gevinstene, men det er fortsatt vesentlig motstand.", "Nivå 3: Moderat enighet - flertallet aksepterer gevinstene, men engasjementet varierer.", "Nivå 4: Høy enighet - bred aksept og aktiv støtte til gevinstene i berørt organisasjon.", "Nivå 5: Full lojalitet - gevinstene er internalisert som felles mål, med observerbar atferdsendring og proaktiv innsats for å nå dem."]}
    ]
}
...
def create_strength_radar(items, max_items=8):
    ...
    categories = [f"{item['title'][:25]}..." if len(item['title']) > 25 else item['title'] for item in items]
    ...
    fig.update_layout(polar=dict(radialaxis=dict(visible=True, range=[0, 5], tickvals=[1,2,3,4,5], tickfont=dict(size=12)), angularaxis=dict(tickfont=dict(size=11))), showlegend=False, height=450, margin=dict(l=120, r=120, t=50, b=50), font=dict(size=12))
    return fig
...
ANONYMOUS_NAMES = [
    ...
    "Deltaker P", "Deltaker Q", "Deltaker R", "Deltaker S", "Deltaker T"
]
            ...
            for q_id in sorted(phase_comments.keys(), key=lambda x: int(x)):
                ...
                for comment in phase_comments[q_id]:
                    html += f'''<div class="comment-item">
                        <div class="comment-meta">{comment['participant']} <span class="score-badge">Nivå {comment['score']}</span></div>
...
def show_main_app(data, current_project_id):
    ...
    with tab4:
        ...
        if not stats or stats['total_interviews'] == 0:
            st.info("Ingen intervjuer gjennomført enda")
        else:
